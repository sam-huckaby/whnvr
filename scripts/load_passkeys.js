...
window.byndid.initialized.then(async (embedded) => {
  ...
  if ( passkeys.length === 0 ) {
    ...
    noPasskeyTile.setAttribute("class", "text-base w-full p-4 lg:p-2 mb-2 flex flex-col justify-center items-center rounded border-2 lg:border border-solid border-whnvr-500");
  ...
  for( const passkey of passkeys ) {
    ...
    passkeyEmail.setAttribute("class", "text-base text-whnvr-500 dark:text-whnvr-400");
